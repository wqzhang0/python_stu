...
from grpc_microservice.room_server_etcd.etcd_server.service_inspection import ServerInspecte
from grpc_microservice.room_server_etcd.smart_client import header_manipulator_client_interceptor
from grpc_microservice.room_server_etcd.smart_server.key_pool import SERVER_UUIDS, SERVER_POOL
...
def register_module(generic_handler):
    ...
    ServerInspecte().add_provide_server(SERVER_POOL['servers'])
