...
server_name= 'room_server_zk'
point  = 'RandomJoinRoom/'
doc= {"a":"b","c":"我的天呢"}
zk.create('/'.join([_server_root, server_name, point]), value=bytes((json.dumps(doc,ensure_ascii=False)), encoding = "utf8"), makepath=True, ephemeral=True,
          sequence=True)
