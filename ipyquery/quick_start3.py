...
class WenJuanXing:
    ...
    def set_post_url(self):
        ...
        url = 'https://www.wjx.cn/joinnew/processjq.ashx?submittype=1&curID={}&t={}&starttim' \
              'e={}&ktimes={}&rn={}&jqnonce={}&jqsign={}'.format(id, time_stamp, start_time, ktimes, rn, jqnonce,
                                                                 jqsign)
    ...
    def post_data(self):
        ...
        # response = requests.post(url=self.post_url, data={"submitdata":'1$1}2$1'}, headers=self.header, cookies=self.cookie)
        return response
...
if __name__ == '__main__':
    w = WenJuanXing('https://www.wjx.cn/jq/47181953.aspx')
    w.set_data({"submitdata": '1$1}2$1'})
    w.mul_run(100)
